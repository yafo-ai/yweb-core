...
from yweb.rbac.decorators import permission_required, role_required
from yweb.rbac.exceptions import PermissionDeniedException
...
class TestPermissionDecorator:
    ...
    def test_permission_required_pass(self):
        """测试权限检查通过"""
        with patch('yweb.rbac.decorators.get_permission_service') as mock_get_service:
            mock_service = Mock()
